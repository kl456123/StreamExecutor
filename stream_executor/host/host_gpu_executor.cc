...
// class declaration].
#include "stream_executor/host/host_gpu_executor.h"

#include <string.h>

#include "absl/synchronization/notification.h"
#include "stream_executor/platform/mem.h"
// #include "stream_executor/platform/profile_utils/cpu_utils.h"
#include "stream_executor/host/host_platform_id.h"
#include "stream_executor/host/host_stream.h"
#include "stream_executor/host/host_timer.h"
...
HostExecutor::CreateDeviceDescription(int device_ordinal) {
  ...
  float cycle_counter_frequency = 1e12;
