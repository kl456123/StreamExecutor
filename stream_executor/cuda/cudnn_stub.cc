...
#include "stream_executor/platform/dso_loader.h"
...
#elif CUDNN_MAJOR < 7
#include "stream_executor/cuda/cudnn_6_0.inc"
#elif CUDNN_MINOR < 1
#include "stream_executor/cuda/cudnn_7_0.inc"
// 2 instead of 3: see https://github.com/tensorflow/tensorflow/issues/32350
#elif CUDNN_MINOR < 2
#include "stream_executor/cuda/cudnn_7_1.inc"
#elif CUDNN_MINOR < 4
#include "stream_executor/cuda/cudnn_7_3.inc"
#elif CUDNN_MINOR < 6
#include "stream_executor/cuda/cudnn_7_4.inc"
#else
#include "stream_executor/cuda/cudnn_7_6.inc"
#endif
